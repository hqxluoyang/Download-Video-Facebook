 ...
 */
public class VideoLikedFragment extends Fragment implements View.OnClickListener {

    public static final String BASE_URL = "https://m.facebook.com";
    public static final String LIKED_URL = "/allactivity?log_filter=likes&locale=en_US";
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    while (it2.hasNext()) {
                        ...
                        Log.d("WATCHED VIDEO", "Element : " + it2.next());
