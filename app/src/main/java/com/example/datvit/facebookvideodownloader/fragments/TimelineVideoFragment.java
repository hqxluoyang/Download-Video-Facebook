...
public class TimelineVideoFragment extends Fragment {
    ...
    private void loadData() {
        if (cd.isConnectingToInternet()) {
            ...
            fb_user_group_url = "https://graph.facebook.com/v2.2/me/feed" +
            ...
            public void onResponse(JSONObject response) {
                try {
                    if (response.has("source")) {
                        TimelineVideoFragment.this.videourl = response.getString("source");
                    } else {
                        TimelineVideoFragment.this.videourl = TimelineVideoFragment.this.videourlmain;
                    }
                    downloadVideoHd();
                } catch (Exception e) {
                }
